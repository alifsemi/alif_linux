 ...
 * @currentmode:		operating mode currently in use, may be
 *				eventually checked by device drivers but
 *				should be considered read-only as this is a
 *				core internal bit
 ...
 * @legacy_scan_el_group:	attribute group for legacy scan elements
 *				attribute group
 * @legacy_buffer_group:	attribute group for legacy buffer
 *				attributes group
 * @bounce_buffer:		for devices that call
 *				iio_push_to_buffers_with_timestamp_unaligned()
