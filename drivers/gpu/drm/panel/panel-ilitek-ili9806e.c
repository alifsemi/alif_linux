...
static const struct ili9806e_instr ili9806e_init[] = {
	...
	ILI9806E_COMMAND_INSTR(0x08, 0x00), /* Output SDA 		*/
	ILI9806E_COMMAND_INSTR(0x20, 0x00),
	ILI9806E_COMMAND_INSTR(0x21, 0x01), /* DE = 1 Active		*/
	ILI9806E_COMMAND_INSTR(0x30, 0x02), /* Resolution 480 X 800	*/
	ILI9806E_COMMAND_INSTR(0x31, 0x00), /* Inversion setting	*/
	ILI9806E_COMMAND_INSTR(0x40, 0x00),  /* BT  			*/
	...
	ILI9806E_COMMAND_INSTR(0x43, 0x89), /* SET VGH clamp level 	*/
	ILI9806E_COMMAND_INSTR(0x44, 0x89), /* SET VGL clamp level	*/
	ILI9806E_COMMAND_INSTR(0x46, 0x34),
	ILI9806E_COMMAND_INSTR(0x50, 0xA8), /* VREG1			*/
	ILI9806E_COMMAND_INSTR(0x51, 0xA8), /* VREG2			*/
	ILI9806E_COMMAND_INSTR(0x52, 0x00), /* Flicker MSB		*/
	ILI9806E_COMMAND_INSTR(0x53, 0x78), /* Flicker LSB = VCOM	*/
	ILI9806E_COMMAND_INSTR(0x54, 0x00),
	ILI9806E_COMMAND_INSTR(0x55, 0x78),
	ILI9806E_COMMAND_INSTR(0x60, 0x07),
	ILI9806E_COMMAND_INSTR(0x61, 0x04),
	ILI9806E_COMMAND_INSTR(0x62, 0x08),
	ILI9806E_COMMAND_INSTR(0x63, 0x04),
	ILI9806E_COMMAND_INSTR(0xA0, 0x00),
	ILI9806E_COMMAND_INSTR(0xA1, 0x0B),
	ILI9806E_COMMAND_INSTR(0xA2, 0x13),
	ILI9806E_COMMAND_INSTR(0xA3, 0x0D),
	ILI9806E_COMMAND_INSTR(0xA4, 0x07),
	ILI9806E_COMMAND_INSTR(0xA5, 0x0B),
	ILI9806E_COMMAND_INSTR(0xA6, 0x07),
	ILI9806E_COMMAND_INSTR(0xA7, 0x06),
	ILI9806E_COMMAND_INSTR(0xA8, 0x07),
	ILI9806E_COMMAND_INSTR(0xA9, 0x0A),
	ILI9806E_COMMAND_INSTR(0xAA, 0x12),
	ILI9806E_COMMAND_INSTR(0xAB, 0x0D),
	ILI9806E_COMMAND_INSTR(0xAC, 0x11),
	ILI9806E_COMMAND_INSTR(0xAD, 0x0F),
	ILI9806E_COMMAND_INSTR(0xAE, 0x0E),
	ILI9806E_COMMAND_INSTR(0xAF, 0x0B),
	ILI9806E_COMMAND_INSTR(0xC0, 0x00),
	ILI9806E_COMMAND_INSTR(0xC1, 0x0B),
	ILI9806E_COMMAND_INSTR(0xC2, 0x13),
	ILI9806E_COMMAND_INSTR(0xC3, 0x0D),
	ILI9806E_COMMAND_INSTR(0xC4, 0x06),
	ILI9806E_COMMAND_INSTR(0xC5, 0x0B),
	ILI9806E_COMMAND_INSTR(0xC6, 0x07),
	ILI9806E_COMMAND_INSTR(0xC7, 0x06),
	ILI9806E_COMMAND_INSTR(0xC8, 0x07),
	ILI9806E_COMMAND_INSTR(0xC9, 0x0A),
	ILI9806E_COMMAND_INSTR(0xCA, 0x12),
	ILI9806E_COMMAND_INSTR(0xCB, 0x0D),
	ILI9806E_COMMAND_INSTR(0xCC, 0x11),
	ILI9806E_COMMAND_INSTR(0xCD, 0x0F),
	ILI9806E_COMMAND_INSTR(0xCE, 0x0E),
	ILI9806E_COMMAND_INSTR(0xCF, 0x0B),
	...
	ILI9806E_COMMAND_INSTR(0x06, 0x98),
	...
	ILI9806E_COMMAND_INSTR(0x0C, 0x01),
	ILI9806E_COMMAND_INSTR(0x0D, 0x01),
	ILI9806E_COMMAND_INSTR(0x0E, 0x00),
	ILI9806E_COMMAND_INSTR(0x0F, 0x00),
	ILI9806E_COMMAND_INSTR(0x10, 0xE0),
	ILI9806E_COMMAND_INSTR(0x11, 0xE0),
	...
	ILI9806E_COMMAND_INSTR(0x3A, 0x77),
	...
	ILI9806E_COMMAND_INSTR(0x36, 0x01),
...
static const struct drm_display_mode focuslcd_fw405_default_mode = {
	...
	.hdisplay	= 480,
	.hsync_start	= 480 + 1163,
	.hsync_end	= 480 + 1163 + 64,
	.htotal		= 480 + 1163 + 64 + 94,
